...
public class LifeController {
    ...
    public void SaveBtnHandler(ActionEvent actionEvent) throws SQLException, ClassNotFoundException, IOException {
        ...
        String data = new String("('" + NameLabel.getText() + "','" + LastNameLabel.getText() + "','" + DateLabel.getEditor().getText() + "','" + RemarksLabel.getText() +"','"+"Life"+ "')");
        //send to logger//
        ins = MyLogger.getInstance();
        ins.insertAction(NameLabel.getText(),LastNameLabel.getText(),DateLabel.getEditor().getText(),RemarksLabel.getText(),"Life");
