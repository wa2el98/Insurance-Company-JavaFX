...
public class CarController {
    ...
    public void SaveBtnHandler(ActionEvent actionEvent) throws SQLException, ClassNotFoundException, IOException {
        ...
        String data = new String("('" + NameLabel.getText() + "','" + LastNameLabel.getText() + "','" + DateLabel.getEditor().getText() + "','" + RemarksLabel.getText() +"','"+"Car"+ "')");

        ins = MyLogger.getInstance();
        ins.insertAction(NameLabel.getText(),LastNameLabel.getText(),DateLabel.getEditor().getText(),RemarksLabel.getText(),"Car");

        /////Data Access Object pattern/////
        ConnectionClass.InsertData(data);
//        MyLo.getInstance().addToFile();
        ////////////////////////////////////
